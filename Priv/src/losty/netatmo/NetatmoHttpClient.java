...
public class NetatmoHttpClient {
	...
	public OAuthJSONAccessTokenResponse login(String email, String password)
		...
		TokenRequestBuilder	tokenRequestBuilder = OAuthClientRequest.tokenLocation(URL_REQUEST_TOKEN);
		tokenRequestBuilder.setGrantType(GrantType.PASSWORD);
		tokenRequestBuilder.setClientId(clientId);
		tokenRequestBuilder.setClientSecret(clientSecret);
		tokenRequestBuilder.setUsername(email);
		tokenRequestBuilder.setPassword(password);
		tokenRequestBuilder.setScope("read_station");
		
		OAuthClientRequest request = tokenRequestBuilder.buildBodyMessage();
		
		OAuthClientRequest test;
		TokenRequestBuilder trb;
